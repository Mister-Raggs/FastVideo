...
def test_cosmos25_arch_allows_fp4_attention_request() -> None:
    assert AttentionBackendEnum.ATTN_QAT_INFER in Cosmos25ArchConfig()._supported_attention_backends
